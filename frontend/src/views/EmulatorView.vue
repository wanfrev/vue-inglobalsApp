...
<template>
  <div class="flex flex-1 lg:divide-x lg:divide-slate-800">

    <!-- Desktop: ControlPanel izquierdo -->
    <div class="hidden w-64 shrink-0 overflow-y-auto p-4 lg:block">
      <ControlPanel />
    </div>
    ...
    <Teleport to="body">
      ...
      >
        ...
        <div class="absolute bottom-0 left-0 right-0 max-h-[70vh] overflow-y-auto rounded-t-2xl bg-slate-900 px-5 pb-8 pt-5 shadow-xl">
          <div class="mb-4 flex items-center justify-between">
            <h3 class="text-sm font-semibold text-slate-100">Configuración</h3>
            <button
              @click="drawerOpen = false"
              class="rounded-full p-1 text-slate-400 hover:bg-slate-800 hover:text-slate-200"
            >
